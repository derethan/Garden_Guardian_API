...
exports.checkForDevice = checkForDevice;
exports.addGarden = addGarden;
exports.getGardens = getGardens;
exports.deleteGarden = deleteGarden;
exports.addGardenGroup = addGardenGroup;
exports.getGardenGroups = getGardenGroups;
exports.deleteGardenGroup = deleteGardenGroup;
exports.addGardenPlant = addGardenPlant;
exports.getGardenPlants = getGardenPlants;
exports.deleteGardenPlant = deleteGardenPlant;
exports.updateGardenPlant = updateGardenPlant;
...
function emailExists(email) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const VALUES = [email];
        const result = yield dbQueryPromise(sql, VALUES);
...
function register(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const emailAlreadyExists = yield emailExists(email);
        ...
        try {
            ...
            yield dbQueryPromise(sql, VALUES);
...
function changePassword(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Get the user from the database
        const user = yield getUser(decoded.email);
        const storedPassword = user[0].password;
...
function addDevice(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const deviceExists = yield sensorController.checkdeviceID(device_id);
...
function checkForDevice(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        //extract the headers
        const tokenHeader = req.headers.authorization;
        if (!tokenHeader) {
...
function addGarden(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield dbQueryPromise(sql2, VALUES2);
...
function addGardenGroup(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const userID = req.params.userID;
        ...
        try {
            ...
            const result2 = yield dbQueryPromise(SQL2, VALUES2);
            if (result && result2) {
...
function addGardenPlant(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const userID = req.params.userID;
        const data = req.body;
...
function getGardenGroups(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const userID = req.params.userID;
...
function getGardenPlants(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const userID = req.params.userID;
...
function deleteGardenGroup(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const userID = req.params.userID;
        ...
        try {
            yield dbQueryPromise(deleteFromUserGroups, deleteFromUserGroups_values).then(() => __awaiter(this, void 0, void 0, function* () {
                yield dbQueryPromise(deleteFromGardenGroups, deleteFromGardenGroups_values);
...
function deleteGardenPlant(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const userID = req.params.userID;
        ...
        try {
            yield dbQueryPromise(deleteFromUserPlants, deleteFromUserPlants_values).then(() => __awaiter(this, void 0, void 0, function* () {
                yield dbQueryPromise(deleteFromGardenPlants, deleteFromGardenPlants_values);
...
//UPDATE
function updateGardenPlant(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const userID = req.params.userID;
        const gardenPlantID = req.params.gardenPlantID;
        const data = req.body;
        ...
        try {
            yield dbQueryPromise(updateGardenPlant, updateGardenPlant_values);
